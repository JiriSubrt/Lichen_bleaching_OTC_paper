...
# Load data
wc <- read.csv("data/desiccation_curves/correct_wc_cleaned.csv")
...
figure_s1 <- wc_0 + wc_5 + wc_10 + wc_15 + wc_20 + wc_25  +
  plot_layout(ncol  = 6)

ggsave("outcomes/dessication_curves/figure_s1.png", plot = figure_s1, width = 11, height = 6, dpi = 300)
